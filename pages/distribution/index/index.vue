<template>
	<view>
		...
		<view class="uni-card">
			<view class="uni-card-content">
				<view class="uni-card-content-inner">
					<image src="http://qiniu.satapp.cn/fuzhi/distributon.png" mode="" style="width: 100%;height: 400upx;"></image>
				</view>
			</view>
			<view class="uni-card-footer">
				...
				<view class="uni-link">
					<label class="checkbox">
						<checkbox value="" checked='true'>我已阅读并同意《分享赚钱须知》</checkbox>
					</label>
				</view>
				</checkbox-group>
			</view>
		...
		<!-- product-list -->
		<view class="uni-center" style="width: 100%;">
			----全部商品----
		</view>
		...
		<!-- footer(fixed) -->
		<view class="uni-foot">
			<view class="uni-foot-item" style="width: 20%;">
			...
			<view class="uni-bg-red uni-foot-last uni-flex-item">
				<text>到店体验</text>
			</view>
		</view>
